...
class MysqlHelper(object):
    ...
    def __init__(self, section, filename='mysql.conf'):
        ...
        try:
            self._conn = MysqlHelper.__getConn(config, section)
    ...
    def __getConn(config, section='mysql'):
        ...
        """
        if section not in MysqlHelper.__pool:
            ...
            MysqlHelper.__pool[section] = pool
        return MysqlHelper.__pool[section].connection()
