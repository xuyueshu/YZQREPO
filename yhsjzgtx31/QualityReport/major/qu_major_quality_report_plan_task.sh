...
cd `dirname $0`
source ../config.sh
exec_dir qu_major_quality_report_plan_task
#专业体规划任务情况

HIVE_DB=assurance
TARGET_TABLE=qu_major_quality_report_plan_task
