          ...
          report_no,index_no,index_name,quality_name,standard_rate,target_rate,major_num,create_time
             ...
             select
                ...
                (
                    ...
                    count(ic.major_no) as major_num
                    from
                    im_quality_info im
                    left join
                    im_major_target_standard_record ic
                    on im.quality_no=ic.quality_no
                    where im.quality_status='NORMAL'
                    and im.index_layer='MAJOR'
                ...
                where a.index_layer='MAJOR' and a.index_level='SECOND'
