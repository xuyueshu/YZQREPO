...
cd `dirname $0`
source ../config.sh
exec_dir qu_teacher_quality_report_plan_task
#教师整体规划完成情况

HIVE_DB=assurance
TARGET_TABLE=qu_teacher_quality_report_plan_task
