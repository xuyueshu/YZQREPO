...
cd `dirname $0`
source ../config.sh
exec_dir qu_student_quality_report_plan_task
#学生体规划任务情况

HIVE_DB=assurance
HIVE_TABLE=qu_student_quality_report_plan_task
TARGET_TABLE=qu_student_quality_report_plan_task
