...
function import_table() {
    find_mysql_data "
        ...
        cast(a.num1/a.num2*100 as decimal(9,2)) as data_value,
        'NO' as is_new,
        ...
        from
           ...
           select
           a.start_date,
           sum(case when a.task_status='YWC' then 1 else 0 end ) as num1,
           count(a.task_no) as num2
           from
           tm_task_info a
		   left join
