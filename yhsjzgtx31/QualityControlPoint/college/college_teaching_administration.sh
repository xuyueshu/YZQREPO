...
cd `dirname $0`
source ./../config.sh
exec_dir college_teaching_administration

HIVE_DB=assurance
HIVE_TABLE=college_teaching_administration
...
function create_table() {
    ...
    fn_log "创建表——学校生均教学行政用房表：${HIVE_DB}.${HIVE_TABLE}"
}
