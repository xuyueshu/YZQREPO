...
cd `dirname $0`
source ./../config.sh
exec_dir college_per_capita_area

HIVE_DB=assurance
HIVE_TABLE=college_per_capita_area
...
function create_table() {
    ...
    fn_log "创建表——学校生均占地面积表：${HIVE_DB}.${HIVE_TABLE}"
}
