...
HIVE_DB=assurance
HIVE_TABLE=college_proportion_senior_teachers_full_time_teachers
exec_dir college_proportion_senior_teachers_full_time_teachers
TARGET_TABLE=im_quality_data_info
DATA_NO=XY_GJZWJSZZRJSBL
                ...
                FROM
                  ...
                  (
                    ...
                    FROM
                      model.basic_teacher_info a
                    WHERE
                      a.professional_title = '教授'
                      or a.professional_title = '副教授'
                    GROUP BY
                      a.semester_year
                  ) b,
