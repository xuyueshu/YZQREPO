...
cd `dirname $0`
source ./../config.sh
exec_dir college_area_structure

HIVE_DB=assurance
HIVE_TABLE=college_area_structure
    ...
    hive -e "
         INSERT INTO TABLE ${HIVE_DB}.${HIVE_TABLE}
            select
                ...
                a.architecture_acreage as data_value,
                'NO' as is_new,
                FROM_UNIXTIME(UNIX_TIMESTAMP()) AS create_time
            from
                model.college_basic_info a,assurance.im_quality_data_base_info c
                where c.data_no = '${DATA_NO}'
                and a.area_covered>0
                ...
                from
                  (
                    select
                      ...
                      a.architecture_acreage as architecture_acreage
                    from
