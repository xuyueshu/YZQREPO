...
HIVE_DB=assurance
HIVE_TABLE=college_postgraduate_teacher_radio
exec_dir college_postgraduate_teacher_radio
TARGET_TABLE=im_quality_data_info
DATA_NO=XY_YJSXLJSZZRJSBL
