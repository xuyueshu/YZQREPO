...
exec_dir college_teacher_average_age
DATA_NO=XY_PJNL
HIVE_TABLE=college_teacher_average_age
                  ...
                  (
                    select
                      substr(
                        ...
                        1,
                        4
                      )- substr(a.identity_card, 7, 4) as num,
                      a.semester_year
                    from
                      model.basic_teacher_info a
                    where
                      a.identity_card is not null
                  ) b,
