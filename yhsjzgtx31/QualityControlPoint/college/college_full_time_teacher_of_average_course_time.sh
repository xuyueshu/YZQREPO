...
HIVE_DB=assurance
HIVE_TABLE=college_full_time_teacher_of_average_course_time
exec_dir college_full_time_teacher_of_average_course_time
    ...
    hive -e "
         INSERT INTO TABLE ${HIVE_DB}.${HIVE_TABLE}
                ...
                (
                  select
                  semester_year,
                  nvl(cast(avg(a.per_teacher_hours) as decimal(9,2)),0) as num
                  from
                  app.college_class_hours_info a
