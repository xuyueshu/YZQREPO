...
cd `dirname $0`
source ./../config.sh
exec_dir college_gender_ratio_of_official_cadres

HIVE_DB=assurance
HIVE_TABLE=college_gender_ratio_of_official_cadres
    ...
    hive -e "
         INSERT INTO TABLE ${HIVE_DB}.${HIVE_TABLE}
                SELECT
                  ...
                  concat(a.num,':',b.num) as data_value,
                  'NO' as is_new,
                  FROM_UNIXTIME(
                    UNIX_TIMESTAMP()
                  ) AS create_time
                ...
                where
                  c.data_no = '${DATA_NO}' and a.semester_year = b.semester_year
         "
}
