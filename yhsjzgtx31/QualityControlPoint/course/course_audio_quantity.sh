...
cd `dirname $0`
source ./../config.sh
exec_dir course_audio_quantity

HIVE_DB=assurance
HIVE_TABLE=course_audio_quantity
...
function create_table() {
    ...
    fn_log "创建表——音频数量：${HIVE_DB}.${HIVE_TABLE}"
}
